...
CREATE TABLE `msspd` (
  ...
  `nmspdmsspd` varchar(100) DEFAULT NULL,
  `vdspdmsspd` int(11) DEFAULT NULL,
  `stspdmsspd` enum('Belum','Sudah','Ditolak') DEFAULT NULL,
  `fcspdmsspd` int(11) DEFAULT NULL,
  `ptspdmsspd` date DEFAULT NULL,
  `atspdmsspd` date DEFAULT NULL,
  `wcspdmsspd` int(11) DEFAULT NULL,
